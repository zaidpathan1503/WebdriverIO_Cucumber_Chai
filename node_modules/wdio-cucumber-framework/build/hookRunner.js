...
var HookRunner = function () {
    ...
    (0, _createClass3.default)(HookRunner, [{
        ...
        value: function handleAfterStep(uri, feature, scenario, step, result) {
            return _get__('executeHooksWithArgs')(this.config.afterStep, (0, _extends3.default)({}, step, { feature: feature.name, scenario: scenario.name, status: result.status }), result);
        }
    }, {
